...
<template>
  <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <template v-else>
      <form class="hidden lg:inline-block" action="#" @submit.prevent="logOut">
        <button
        ...
        <div class="pt-6">
          ...
          <template v-else>
            <form action="#" @submit.prevent="logOut">
              <button
                class="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-yellow-600 hover:bg-yellow-700 rounded-xl"
                type="submit"
              >
                Cerrar sesión
              </button>
    ...
    <div class="container m-auto p-4 md:py-8">
      <div class="sm:flex sm:items-center sm:justify-between">
        ...
        >
          ...
          <li>
            <router-link to="/servicios" class="mr-4 hover:underline md:mr-6"
              >Servicios</router-link
            >
          </li>
          <template v-if="!user.id">
